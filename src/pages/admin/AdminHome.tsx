...
import { Building2, BarChart3, ScrollText, CalendarDays, LifeBuoy, Video } from "lucide-react";
...
export default function AdminHome() {
  ...
  const cards = [
    ...
    { icon: <Video className="w-5 h-5" />, title: "Coaching Night", desc: "首页「过往录像」的增删改 · 不用改代码发版", to: "/admin/coaching", soon: null },
