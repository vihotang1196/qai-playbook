  ...
  return (
    <div className="space-y-5">
      <div className="glass-card rounded-3xl p-6 sm:p-8">
        <div
          className="w-14 h-14 rounded-2xl flex items-center justify-center mb-4 text-[#fed50a]"
      ...
      {isCustomerView && locationId ? (
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          >
            <div
              className="w-11 h-11 rounded-xl flex items-center justify-center text-[#fed50a] shrink-0"
              style={{ background: "#141414" }}
            >
            ...
            <ArrowRight className="w-4 h-4 text-muted-foreground group-hover:text-[#141414] transition-colors" />
          </Link>
          <Link
        ...
        <div className="glass-card rounded-2xl p-5 flex items-start gap-3">
          <Info className="w-5 h-5 text-[#141414] shrink-0 mt-0.5" />
