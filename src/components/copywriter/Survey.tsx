...
// Two-column on desktop, single column on phones. Fields that need the full
// width (long text, the age slider) opt in with `md:col-span-2`.
const GRID_CLS = "grid grid-cols-1 gap-x-6 gap-y-5 md:grid-cols-2";
      ...
      <Card className="glass-panel space-y-8 p-6">
        ...
        <section className="space-y-4">
          ...
          <div className={GRID_CLS}>
            ...
            <Field label={t.productDesc} required className="md:col-span-2">
              <Input
                className={FIELD_CLS}
            ...
            <Field label={t.usp} required className="md:col-span-2">
              <Textarea
                className={FIELD_CLS}
                rows={3}
                value={data.usp}
        ...
        <section className="space-y-4">
          ...
          <div className={GRID_CLS}>
            {/* Full width: the range slider needs the room. */}
            <Field label={t.ageRange} required className="md:col-span-2">
              {(() => {
                const isUnlimited =
            ...
            {/* Paired side by side — same rows so the two boxes line up. */}
