...
interface CopywritingPopoutProps {
  triggerLabel: string;
}

const CopywritingPopout = ({ triggerLabel }: CopywritingPopoutProps) => {
  ...
  return (
    <div className="relative w-full" ref={wrapperRef}>
      ...
      {/* List popout — card 04 is right column, so open to the right (video left, list right) */}
      {listOpen && (
        <div
          ref={listRef}
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 pt-4 pb-2 shrink-0">
              <div>
                <p className="text-foreground font-semibold text-sm tracking-tight">文案攻略</p>
...
export default CopywritingPopout;
